"""
Stamina Burner — pursues aggressively in extended stance until stamina
drops below 20%, then recovers in neutral.  Dead zone between 20%-40%
uses moderate pursuit.  Teaches the agent to exploit stamina depletion
windows.
