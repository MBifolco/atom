"""
Storm_Mantis_G15 — Trained AI fighter exported from population training.

Record: 18-10-0
ELO: 1518
Generation: 15
Lineage: Storm_Mantis_G15
...
_model = None
_model_path = str(Path(__file__).parent / "Storm_Mantis_G15.zip")
