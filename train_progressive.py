...
# Backward-compatible export: callers can still import ProgressiveTrainer
# from train_progressive.py, but the implementation now lives in
# src.training.pipelines.progressive_trainer.
