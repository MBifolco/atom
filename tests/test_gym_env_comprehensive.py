...
class TestAtomCombatEnvInit:
    ...
    def test_observation_space_shape(self):
        ...
        assert env.observation_space.shape == (26,)  # Enhanced observation space
...
class TestAtomCombatEnvReset:
    ...
    def test_reset_returns_observation(self):
        ...
        assert obs.shape == (26,)  # Enhanced observation space
...
class TestAtomCombatEnvIntegration:
    ...
    def test_observation_normalization(self):
        ...
        for _ in range(5):
            ...
            # HP and stamina should be in [0, 1] (egocentric layout)
            assert 0 <= obs[2] <= 1  # you_hp
            assert 0 <= obs[3] <= 1  # you_stamina
            assert 0 <= obs[4] <= 1  # opponent_hp
            assert 0 <= obs[5] <= 1  # opponent_stamina
