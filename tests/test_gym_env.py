...
class TestAtomCombatEnv:
    ...
    def test_observation_space(self):
        ...
        assert env.observation_space.shape == (12,)  # Enhanced observation space
        assert len(env.observation_space.low) == 12
        assert len(env.observation_space.high) == 12
    ...
    def test_reset_returns_valid_observation(self):
        ...
        assert obs.shape == (12,)  # Enhanced observation space
